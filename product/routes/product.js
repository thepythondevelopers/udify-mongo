...
const {getSingleProduct,getProductAccordingtoStore,deleteProductShopify,createProductShopify,updateProductShopify,syncProduct,test} = require("../controllers/product");
